  ...
  return (
    <div>
      ...
      <p>
        ...
        based on the top-up amount, the more you buy, the more the price will be
        lowered. We use this system to encourage our resellers to increase their
        sales without the fear to have a big amount of expenses. The credits
        never expire and this plan is not subjected to any commitment.
      </p>
      <p>
      ...
      <div><p>need help? <span>Contact Us</span> Today Or Choose Reseller plan and start making money</p></div>
    </div>
  );
};
